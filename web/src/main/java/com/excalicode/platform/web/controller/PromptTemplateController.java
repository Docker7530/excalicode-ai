...
public class PromptTemplateController {
    ...
    public ResponseEntity<List<PromptTemplate>> list() {
        List<PromptTemplate> templates = promptTemplateService.list();
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<List<PromptTemplate>> search(@RequestParam String keyword) {
        List<PromptTemplate> templates = promptTemplateService.search(keyword);
        return ResponseEntity.ok(templates);
    }
    ...
    public ResponseEntity<PromptTemplate> getByCode(@PathVariable String code) {
