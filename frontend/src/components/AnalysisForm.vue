  ...
  <div class="analysis-form">
    ...
    <form class="form-content" novalidate @submit.prevent="handleSubmit">
      ...
      <div class="form-group">
        ...
        <div
          class="dev-notice"
          :class="{ 'dev-notice--highlight': noticeHighlighting }"
          @animationend="handleNoticeAnimationEnd"
        >
          ...
          <div class="notice-content">
            ...
            <div class="notice-links">
              ...
              <a
                href="https://www.kdocs.cn/l/cdxVmC4hTihU"
                target="_blank"
...
export default {
  ...
  methods: {
    ...
    /**
     * 处理提示动画结束
     * @param {AnimationEvent} event 动画事件
     */
    handleNoticeAnimationEnd(event) {
      if (event?.animationName !== 'noticeFlash') return;
      this.noticeHighlighting = false;
    },
  },
};
</script>
...
.dev-notice--highlight {
  animation: noticeFlash 2.4s ease-out both;
}
...
@keyframes noticeFlash {
  ...
  25% {
    ...
    box-shadow: 0 12px 28px rgba(33, 150, 243, 0.35);
